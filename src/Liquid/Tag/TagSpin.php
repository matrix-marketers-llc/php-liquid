 ...
 *     one one two two
 */
class TagSpin extends AbstractTag
{
	/**
	...
	public function __construct($markup, array &$tokens, FileSystem $fileSystem = null)
	{
		...
		if ($namedSyntax->match($markup)) {
			...
			throw new ParseException("Syntax Error in 'spin' - Valid syntax: spin [name :] var [, var2, var3 ...]");
		}
	}
	...
	public function render(Context $context)
	{
        ...
        $key = array_rand($this->variables);
		$result = $context->get($this->variables[$key]);
